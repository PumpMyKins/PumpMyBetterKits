...
import net.kaikk.mc.betterkits.sponge.commands.DeleteAllCommand;
import net.kaikk.mc.betterkits.sponge.commands.DeleteCommand;
import net.kaikk.mc.betterkits.sponge.commands.EditCommand;
import net.kaikk.mc.betterkits.sponge.commands.GiveAllCommand;
...
public class BetterKits {
	...
	public void onGameInitialization(GameInitializationEvent event) throws Exception {
		...
		Sponge.getCommandManager().register(this, 
				CommandSpec.builder()
				.permission("betterkits.give")
				.description(Text.of("GiveAllCommand"))
				.executor(new GiveAllCommand(this)).build(), "kitgiveall");
		Sponge.getCommandManager().register(this, 
				CommandSpec.builder()
				.permission("betterkits.give")
				.description(Text.of("DeleteAllCommand"))
				.executor(new DeleteAllCommand(this)).build(), "kitdelete");
	}
	...
	synchronized public void loadData() throws IOException, ObjectMappingException {
		...
		List<String> playerUuidList = rootNode.getNode("UuidList").getList(TypeToken.of(String.class));
		this.setUuidList(playerUuidList);
	}
	...
	synchronized public void saveData() throws IOException, ObjectMappingException {
		...
		rootNode.getNode("UuidList").setValue(UuidSerializer.token, new ArrayList<String>(this.uuidList));
